...
function saveStock() {
    ...
    let bought =Number(document.getElementById('bought-weight').value);
    let sold = 0;               //fixed since you can't already sold something you just added//
    let buyPrice =Number(document.getElementById('buy-price').value);
    let sellPrice = Number(document.getElementById('sell-price').value);
